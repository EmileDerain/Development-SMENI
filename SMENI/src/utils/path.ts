const URL = "172.16.6.108" //TODO : ipconfig et mettre son addresse IP locale
...
export {URL_LOGIN, URL_SIGNUP, URL_AUDIO, URL_PREDICT, PAGE_SIGNUP, PAGE_DIAGNOHELP, PAGE_SIGNIN, PAGE_SEARCH_PATIENT}